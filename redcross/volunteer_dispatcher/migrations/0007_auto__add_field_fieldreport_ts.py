...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldReport.ts'
        db.add_column('volunteer_dispatcher_fieldreport', 'ts',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FieldReport.ts'
        db.delete_column('volunteer_dispatcher_fieldreport', 'ts')
