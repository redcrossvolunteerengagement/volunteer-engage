...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.required_responders'
        db.add_column('volunteer_dispatcher_incident', 'required_responders',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Incident.required_trainees'
        db.add_column('volunteer_dispatcher_incident', 'required_trainees',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Incident.required_responders'
        db.delete_column('volunteer_dispatcher_incident', 'required_responders')

        # Deleting field 'Incident.required_trainees'
        db.delete_column('volunteer_dispatcher_incident', 'required_trainees')
