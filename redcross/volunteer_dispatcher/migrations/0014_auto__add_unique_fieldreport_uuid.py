...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FieldReport', fields ['uuid']
        db.create_unique('volunteer_dispatcher_fieldreport', ['uuid'])

    def backwards(self, orm):
        # Removing unique constraint on 'FieldReport', fields ['uuid']
        db.delete_unique('volunteer_dispatcher_fieldreport', ['uuid'])
    ...
    models = {
        ...
        'volunteer_dispatcher.fieldreport': {
            ...
            'uuid': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
