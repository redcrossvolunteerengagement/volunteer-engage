...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.volunteer'
        db.add_column('volunteer_dispatcher_incident', 'volunteer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteer_dispatcher.Volunteer'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Incident.volunteer'
        db.delete_column('volunteer_dispatcher_incident', 'volunteer_id')
