...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldReport.read_ts'
        db.add_column('volunteer_dispatcher_fieldreport', 'read_ts',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FieldReport.read_ts'
        db.delete_column('volunteer_dispatcher_fieldreport', 'read_ts')
