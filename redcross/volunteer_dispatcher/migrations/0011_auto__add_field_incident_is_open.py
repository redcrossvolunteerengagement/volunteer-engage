...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.is_open'
        db.add_column('volunteer_dispatcher_incident', 'is_open',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Incident.is_open'
        db.delete_column('volunteer_dispatcher_incident', 'is_open')
