...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FieldReport.longitude'
        db.alter_column('volunteer_dispatcher_fieldreport', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6))

        # Changing field 'FieldReport.latitude'
        db.alter_column('volunteer_dispatcher_fieldreport', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FieldReport.longitude'
        raise RuntimeError("Cannot reverse this migration. 'FieldReport.longitude' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FieldReport.latitude'
        raise RuntimeError("Cannot reverse this migration. 'FieldReport.latitude' and its values cannot be restored.")
    models = {
        'auth.group': {
